...
# Define the model for Personality Test Questions
class PersonalityTestQuestions(db.Model):
    ...
    answers = relationship("PersonalityTestAnswers", back_populates="question")  # Relationship with answers

# Define the model for Personality Test Answers
...
def signup():
    ...
    if request.method == 'POST':  # Check if the form has been submitted
        ...
        flash('Sign up successful! Please log in.')  # Notify the user of a successful sign-up
